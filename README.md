...
一个可复用的 Codex Skill：每日抓取 B站的「综合热门」「全站排行榜」和最新一期「每周必看」，把主题相关视频归为 AI 软件、科技硬件 / 3C 或 AIGC 内容，并在这三个热门榜单里识别可与主题重叠的视频播客机会，最后把结果写成按日期累积的飞书日报。它也可以持续采样综合热门，分析榜单的实际更新规律。
...
“视频播客机会”既不是第四个主题分类，也不是第四个固定数据源。Skill 只从当天三榜候选中识别播客形态：标题或独立标签明确写有“视频播客/播客/Podcast”，或者视频至少 20 分钟且同时具备对谈与期数、主播/嘉宾结构。时长、“上B站看播客”等活动标签和 UP 主历史都不能单独作为结论。
...
区分“AI 软件”“科技硬件 / 3C”与“AIGC 内容”，并在三榜候选中另列可重叠的视频播客机会，覆盖消费数码、创客工程和航空航天，标注产品、品牌和明确披露的客户，
并写入或刷新配置的飞书文档当天章节。
...
- 综合热门会随时间和访问会话变化；日报记录的是三榜运行时快照。官方视频播客专区样本不参与日常抓取。
